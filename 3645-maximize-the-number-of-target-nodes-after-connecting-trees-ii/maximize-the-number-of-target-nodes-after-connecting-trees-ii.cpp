...
public:
    ...
    void dfs(int curr,
        ...
        for (auto &ngbr : adj[curr]) {
            ...
            if (ngbr != parent) {
                ...
                dfs(ngbr, adj, curr, mark,
                    zeroMarkedCount, oneMarkedCount);
            }
        }
    }
    ...
    vector<int> maxTargetNodes(vector<vector<int>>& edges1,
        ...
        dfs(0, adjA, -1, markA,
            zeroMarkedCountA, oneMarkedCountA);
        ...
        dfs(0, adjB, -1, markB,
            zeroMarkedCountB, oneMarkedCountB);


        int maxFromTree2 = max(zeroMarkedCountB,
                               oneMarkedCountB);
